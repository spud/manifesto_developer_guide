...
* $request->module: The primary module responsible for handling the request
* $request->function: The function to execute in that module ('display','edit','list','add_to_cart',etc). This may be empty, in which case a default handler is executed
* $request->id: The specific content ID being requested (optional) 
...
#. Load [module]/controller.inc
   ...
   #. One of the handlers in the controller, based on the $request->function being called determines the next include.
